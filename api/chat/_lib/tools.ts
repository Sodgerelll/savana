...
export const CHAT_TOOLS = [
  {
    functionDeclarations: [
      ...
      },
      {
        ...
        description:
          'Захиалгын эхний алхам: захиалах бүтээгдэхүүнийг бүртгэнэ. ' +
          'Хэрэглэгч тодорхой бүтээгдэхүүн авах хүсэлтэй үед хэрэглэнэ. ' +
          'Зөвхөн үнэ асуусан үед, эсвэл нэр/утас/хаяг ирсэн үед хэрэглэхгүй ' +
          '(сүүлийнх нь confirm_order-т хамаарна).',
        parameters: {
          type: 'object',
          properties: {
      ...
      },
      {
        ...
        description:
          'Захиалгын хоёр дахь алхам: захиалгыг баталгаажуулж, төлбөрийн холбоос үүсгэнэ. ' +
          'Нэр, утасны дугаар, хүргэлтийн хаяг гурвуулаа мэдэгдсэн үед хэрэглэнэ — ' +
          'нэг мессежээр ирсэн ч, тус тусдаа ирсэн ч адил. ' +
          'Аль нэг нь дутуу бол хэрэглэхгүй, дутуугаа эелдэгээр асууна.',
        parameters: {
          type: 'object',
          properties: {
