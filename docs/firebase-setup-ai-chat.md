...
> ## ✅ 2026-08-16-нд ГҮЙЦЭТГЭСЭН
>
> Гурван алхам бүгд `savana-3f45a` дээр хийгдсэн:
> rules · 17 индекс · 2 TTL policy. Доорх заавар нь **бүртгэл** болон дахин
> хийх шаардлага гарвал ашиглах зорилготой үлдээв.
>
> Одоо `firebase.json`-д `indexes` мөр нэмэгдсэн тул цаашид дараах ганц
> командаар гурвуулан шинэчилнэ:
>
> ```bash
> firebase deploy --only firestore:rules,firestore:indexes --project savana-3f45a
> ```
>
> ⚠️ Deploy хийхээс өмнө **үргэлж** `firebase firestore:indexes` ажиллуулж, амьд
> дээр байгаа бүх индекс `firestore.indexes.json`-д байгаа эсэхийг шалга. Файлд
> байхгүй индексийг CLI устгахыг санал болгодог.
